...
export function PanelDireccion({
  ...
  useEffect(() => {
    ...
    sujeto.addBinding(ajustesDireccion.sujeto, "retencion", { min: 0.5, max: 10, step: 0.1 });
    sujeto.addBinding(ajustesDireccion.sujeto, "gesto", { min: 0.02, max: 0.6, step: 0.01 });
    sujeto.addBinding(ajustesDireccion.sujeto, "alto", { min: 0, max: 0.15, step: 0.005 });
    sujeto.addBinding(ajustesDireccion.sujeto, "respiracion", { min: 0, max: 0.08, step: 0.002 });
    sujeto.addBinding(ajustesDireccion.sujeto, "balanceo", { min: 0, max: 8, step: 0.1 });
